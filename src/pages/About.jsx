...
function About() {
        ...
        <div className="aboutWrapper">
            <div className='aboutContainer'>           
                ...
                <div id="reliabContent" className="reliab-content">Les annonces postées sur Kasa garantissent une fiabilité totale. Les photos sont conformes aux logements, et toutes les informations sont régulièrement vérifiées  par nos équipes.</div>
